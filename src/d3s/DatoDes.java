...
public class DatoDes {
    ...
    static String l, r, l1, r1, t, lr, sbox, text2, text3 = "";
    ...
    public void datoDes(String clave, String dato) {
        getKeys(clave);
        dato = perm(IP, dato);
        lr = "" + dato.substring(0, 32) + dato.substring(32, 64);
        for (int i = 0; i < 16; i++)
            step(keys[i]);
        dato = "" + lr.substring(32, 64) + lr.substring(0, 32);
        dato = perm(FP, dato);
        System.out.println("Texto cifrado: " + dato);
    }  
    
    public static String perm(int[]table, String text) {
        text2 = "";
        for (int i = 0; i < table.length; i++)
            text2 += text.charAt(table[i] - 1);
        return text2;
    }  
    ...
    public static void step(String key) {
        ...
        r = perm(Permutation, l1);
        r1 = "";
        for (int i = 0; i < 32; i++)
            r1 += r.charAt(i) ^ l.charAt(i);
        l1 = lr.substring(32, 64);
        lr = l1 + r1;
    }  
}
